...
function Home({ changeTheme, theme }) {
  ...
  const Donate = () => {
    window.open('donate.chainlist.tk', '_blank')
  }
        ...
        <div className={ theme.palette.type === 'dark' ? classes.containerDark : classes.container }>
          <div className={ classes.copyContainer }>
            <div className={ classes.copyCentered }>
              <Typography variant='h1' className={ classes.chainListSpacing }><span className={ classes.helpingUnderline }>Chainlist.tk</span></Typography>
              <Typography variant='h2' className={ classes.helpingParagraph }>Helping users connect to EVM powered networks</Typography>
              <Typography className={classes.subTitle}>Chainlist is a list of EVM networks. Users can use the information to connect their wallets and Web3 middleware providers to the appropriate Chain ID and Network ID to connect to the correct chain. This is a chainlist.org fork.</Typography>
              <Button
                size='large'
                color='primary'
                variant='contained'
              ...
              <Button
                ...
                onClick={ Donate }
              >
                <Typography className={ classes.buttonLabel }>Donate</Typography>
              </Button>
            </div>
          </div>
